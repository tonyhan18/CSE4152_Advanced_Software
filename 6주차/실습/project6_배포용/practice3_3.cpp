...
void practice3_3(void) {
	...
	printf("\n>>>>>>>>>> practice3_3 <<<<<<<<<\n");
	double ans = 0.0;
	printf("초기값 1 : x(0) = (0.0, 0.0, 0.0)\n");
	fprintf(fp_w, "초기값 1 : x(0) = (0.0, 0.0, 0.0)\n");
	...
	printf("초기값 2 : x(0) = (1.55, 1.39, 1.10)\n");
	fprintf(fp_w, "초기값 2 : x(0) = (1.55, 1.39, 1.10)\n");
	x[0] = 1.55;
	x[1] = 1.39;
	x[2] = 1.10;
	hybrj1_(fcn3_3, &n, x, fvec, fjac, &ldfjac, &tol, &info, wa, &lwa);
